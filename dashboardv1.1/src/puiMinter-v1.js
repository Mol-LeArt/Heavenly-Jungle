...
const NFT = moralis.Object.extend( "NFT", { /* Instance methods*/ }, 
        {  
            newNFT: function(dict,fileHash,commonsContractAddress,gammaContractAddress,supply) { 
                                        const nft = new NFT();
 ...
 // ----- Mint Gamma with MolVault
   ...
   async (price, coins, tokenURI, commonsContractAddress, dict, fileHash ) => {
                                                               ...
                                                               //     alert( 'supply ' + supply );
                                                                    ...
                                                                    const tx = await _contract.mint( price, coins, tokenURI, sale ? 1 : 0, price )//<<TODO!!                                                    
                                                                    ...
                                                                    tx.wait().then((receipt) => { 
                                                                                                    if (receipt.confirmations === 1) 
                                                                                                    {
                                                                                                        ...
                                                                                                        alert( 'save nft ' );
                                                                                                        const newNFT = NFT.newNFT( dict, fileHash, commonsContractAddress, gammaAddress, supply );
                                                                                                        newNFT.save();     
                                                                                                        alert( 'saved' );
                                                                                                    }
                                                                                                 })
