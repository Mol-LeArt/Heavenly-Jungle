...
// On file select (from the pop up)
    ...
    const save = async () => {  
       ...
       return (
                    <div className="App" >
                        <Panel {...{title: 'Edit Profile', titleCols: [<FlexCol fixed><BrandButton href="/heavenly-jungle/select" >Home</BrandButton><SignIn callBack={callbackFunction}/></FlexCol>], style: {  padding: '8px', background: '#f2f2f2'}}}>
