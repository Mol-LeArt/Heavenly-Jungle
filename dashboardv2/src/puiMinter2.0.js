...
//On file select (from the pop up)
  ...
  const uploadAndMint = async (hash) => {
                                            ...
                                            try {
                                                ...
                                                //    const c = ethers.utils.parseEther(coinPrice)
                                                  //  alert( 'contract params eth price ' + p + ' uri ' + tokenUri + '  address ' + contractaddress );
                                                    molCommons(p, tokenUri, contractaddress, dict, hash )
 ...
 // ----- Mint Gamma with MolVault
   const molCommons = 
   async (price, tokenURI, commonsContractAddress, dict, fileHash ) => {
