    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
      ...
      return (
                    <div className="App full-height" > {gammaAddress && 
                        <Panel {...{title: 'NFT View', titleCols: [<FlexCol fixed><BrandButton href="/heavenly-jungle/select/" >Home</BrandButton><SignIn callBack={callbackFunction}/></FlexCol>], style: {  height: '100%', padding: '8px', background: '#f2f2f2'}}}>
