    ...
    const save = async () => {  
       ...
       return (
                    <div className="App full-height" >
                        <Panel {...{title: 'Edit Profile', titleCols: [<FlexCol fixed><BrandButton href="/heavenly-jungle/select" >Home</BrandButton><SignIn callBack={callbackFunction}/></FlexCol>], style: {  height: '100%',  padding: '8px', background: '#f2f2f2'}}}>
