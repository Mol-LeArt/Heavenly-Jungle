                    ...
                    <div className="App" > {gammaAddress && 
                        ...
                        <Grid className="grid-show ">
                            <FlexCol fixed {...{style: {width: '25%'}}}>
                                <img className="nftview" src={image} /><br/><br/>
                                {gammaAddress && ( isSale == 1 ) && ! ownerMatch  && <BrandButton onClick={buyWithEth} >Buy with ETH {price} Ξ</BrandButton>}<br/><br/>
                            ...
                            <FlexCol {...{style: {padding: '8px'}}} >
                                 ...
                                 <br/><br/><TooltipTrigger tooltip={'https://ropsten.etherscan.io/tx/' + txHash}>
                                 <BrandButton target="_blank" href={'https://ropsten.etherscan.io/tx/' + txHash} >View Etherscan TX</BrandButton></TooltipTrigger>

                                { ( ownerMatch && <div><br/><br/><h3>You Own It!</h3><TooltipTrigger tooltip={unlockLink}>
